 ...
 * Author: joser
 *
 * Created on 20 de marzo de 2020, 05:40 PM
 */
...
uint8_t humo;   // Variables en las que guardamos lo leido
...
void __interrupt() isr(void)
{
    ...
    // =========================================================================
        ...
        else if(!SSPSTATbits.D_nA && SSPSTATbits.R_nW)     // Envio de datos > Esclavo a Maestro
        {
            ...
            SSPBUF = humo;           // El valor del sensor de LUZ lo cargamos al Buffer
...
void setup()
{
    ...
    ANSELbits.ANS0 = 1;     // Sensor de humo: entrada analógica.
    
    TRISAbits.TRISA0 = 1;   // Sensor de humo: entrada analógica.
...
void main(void) 
{
    ...
    iniciarADC(2,0);    // Configuramos ADC para lectura de humo
    
    I2C_Esclavo(0x40);    // Este sera un esclavo con direccion 0x10
