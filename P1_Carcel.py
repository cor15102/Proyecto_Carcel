...
ADAFRUIT_IO_KEY = "aio_OFAn29budHLhI402VWSI7FAa1KKq"

# Set to your Adafruit IO username.
# (go to https://accounts.adafruit.com to find your username)
ADAFRUIT_IO_USERNAME = "rodrigocorona97"
...
while True:
    value1 = random.randint(0, 400)
    print('Publishing {0} to Distancia.'.format(value1))
    client.publish('Distancia', value1)
    time.sleep(10)
    
    value2 = random.randint(0, 50)
    print('Publishing {0} to Humo.'.format(value2))
    client.publish('Humo', value2)
    time.sleep(10)
    
    value3 = random.randint(0, 24)
    print('Publishing {0} to Celda.'.format(value3))
    client.publish('Servomotor', value3)
    time.sleep(10)
    
    value4 = random.randint(0, 100)
    print('Publishing {0} to Temperatura.'.format(value4))
    client.publish('Temperatura', value4)
    time.sleep(10)
